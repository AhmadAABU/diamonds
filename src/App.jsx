...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-500 via-fuchsia-500 to-emerald-400 dark:bg-none dark:bg-[#0a0a0f] flex items-center justify-center px-4 py-20 sm:p-4 relative overflow-x-hidden font-sans transition-colors duration-500">
      ...
      <div className="relative w-full max-w-md rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl shadow-indigo-500/20 dark:shadow-black/90 p-6 pt-8 sm:p-8 sm:pt-10 transition-all duration-500 backdrop-blur-2xl bg-white/70 dark:bg-[#12121a]/90 border border-white/50 dark:border-white/10 z-10 mx-auto">
            ...
            return (
              ...
              <span>{currentFrom} {"->"} {currentTo}</span>
                <button
                  ...
                  className={`ml-2 p-1.5 rounded-lg transition-all hover:scale-110 outline-none ${
                    isActive
        ...
        <div className="relative mb-4 sm:mb-6 group">
          ...
          />
          <Calculator className="absolute left-3.5 sm:left-4 top-1/2 -translate-y-1/2 text-indigo-500 dark:text-indigo-400 w-5 h-5 sm:w-6 sm:h-6 transition-transform group-focus-within:scale-110" />
        </div>
{result && (
    ...
    {copied && (
            ...
            {shipments.map((s) => (
              ...
              >
                <div className="grid grid-cols-2 gap-y-2 gap-x-4">
                  <div className="flex items-center gap-2"><span className="text-gray-400 dark:text-gray-500">📌 إدخال:</span> <span className="font-bold">{s.input}</span></div>
                  <div className="flex items-center gap-2"><span className="text-gray-400 dark:text-gray-500">💲 سعر:</span> <span className="font-bold">{s.rate}</span></div>
                  <div className="col-span-2 flex items-center gap-2"><span className="text-gray-400 dark:text-gray-500">💎 نتيجة:</span> <span className="font-bold text-indigo-600 dark:text-indigo-400">{s.result}</span></div>
                  <div className="col-span-2 flex items-center gap-2"><span className="text-gray-400 dark:text-gray-500">🔄 الحالة:</span> <span className="font-medium bg-gray-200/50 dark:bg-white/5 px-2 py-0.5 rounded-md">{SCENARIO_NAMES[s.scenario]}</span></div>
                  <div className="col-span-2 flex items-center gap-2"><span className="text-gray-400 dark:text-gray-500">👤 ID:</span> <span className="font-mono text-xs bg-indigo-100 dark:bg-indigo-500/15 px-2 py-1 rounded text-indigo-800 dark:text-indigo-300">{s.userId}</span></div>
                </div>
      ...
      {showIdModal && (
        <div className="fixed inset-0 bg-gray-900/50 dark:bg-black/80 backdrop-blur-md flex items-center justify-center z-50 animate-fade-in p-4 sm:p-6">
          <div className="bg-white/95 dark:bg-[#12121a]/98 backdrop-blur-xl border border-white/50 dark:border-white/10 rounded-[2rem] sm:rounded-3xl p-6 sm:p-8 w-full max-w-[90%] sm:max-w-sm shadow-2xl animate-fade-in-up">
